...
class FBMCModule(object):
    ...
    def create_Ab_from_jao_data(self):
        ...
        jao_data_raw = pd.read_csv(self.wdir.joinpath("data_input/gsk/JAO_complete_CBCO.csv"), sep=",", encoding='ISO8859')
        ...
        for t in timestep_dict:
            ...
            jao_data_raw.loc[jao_data_raw.utc_timestamp == t, "timestep"] = timestep_dict[t]
