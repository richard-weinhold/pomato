...
result_F_dc(t,dc) = F_DC_pos.l(t,dc) - F_DC_neg.l(t,dc);

result_H(t,p) = H.l(t,p);
result_H(t,bb) = result_H(t,bb) + H_b.l(t,bb) ;
...
execute 'gdxdump %result_folder%/result.gdx output=%result_folder%/H.csv symb=result_H format=csv header="t,p,H"'
...
execute 'gdxdump %result_folder%/result.gdx output=%result_folder%/G.csv symb=G format=csv header="t,p,G"'
execute 'gdxdump %result_folder%/result.gdx output=%result_folder%/F_DC.csv symb=result_F_dc format=csv header="t,dc,F_DC"'
